...
So, now we have our totally original logo shape appearing on screen and it's time to draw some text on it. I'll explain why the colour palette has been set up the way it has, in the code.
